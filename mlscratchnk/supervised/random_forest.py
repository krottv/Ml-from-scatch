...
class RandomForest(ABC): 
    ...
    All other parameters are the same as in decision_tree except splitter (always random)
...
class RandomForestRegressor(RandomForest):
    def initDecisionTree(self, random_state):
        return DecisionTreeRegressor(max_depth=self.max_depth, min_samples_split=self.min_samples_split, min_samples_leaf=self.min_samples_leaf, criterion='mse', debug=self.debug, splitter='random', min_impurity_decrease=self.min_impurity_decrease, random_state=random_state)
